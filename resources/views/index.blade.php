...
<div class="row">
    <div class="col-md-12">
        <h2><strong>Выгодные курсы валют в вашем городе на сегодня {{date('d.m.Y', time())}}</strong></h2><br>
        <h3 style="display: inline">Выбирите город или воспользуйтесь поиском&nbsp;&nbsp;&nbsp;</h3>
        <form style="display: inline" action="{{ asset('js/search.php') }}" method="post" name="form" onsubmit="return false;">
            {{ csrf_field() }}
...
<div id="hidden" class="row col-md-12 text-justify bmargin">
